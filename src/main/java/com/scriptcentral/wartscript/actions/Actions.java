...
public static int WALK_ANGLE = 15;
private int intervalDelay = 50;
private int endOfRowWait = 100;
public static int FLY_ANGLE = 35;
private Look Look = new Look();
public static int leftOfRightMult;
public static int rows = 0;
    ...
    //if (!Minecraft.getMinecraft().theWorld.isAirBlock(actionUtils.getPos().add(0, -1, 0)) && Minecraft.getMinecraft().theWorld.isAirBlock(actionUtils.getPos())) {
        ...
        Look.newLook(150, 0, permdat.tempDir.numVal + ((FLY_ANGLE + 5) * leftOfRightMult));
        //
...
//        }
        ...
        actionUtils.intervalCheck(1, true, intervalDelay);
        movement.forward.move(true);
        //
        if (!actionUtils.checkStatus()) {
            return;
...
//        }
    ...
    public void doActionsWalk() {
        ...
        new Attack().attack(true);
        leftOfRightMult = actionUtils.dirMult();
        Look.newLook(150, 0, permdat.tempDir.numVal + (WALK_ANGLE * leftOfRightMult));
        //
        ...
        while (Minecraft.getMinecraft().theWorld.isAirBlock(actionUtils.getPos().add(0, -1, 0)) && Minecraft.getMinecraft().theWorld.isAirBlock(actionUtils.getPos())) {
            ...
            System.out.println(Minecraft.getMinecraft().thePlayer.motionY);
        ...
        actionUtils.intervalCheck(actionUtils.getNextCheckDirection(1), true, intervalDelay);
        ...
        actionUtils.intervalCheck(actionUtils.getNextCheckDirection(2), true, intervalDelay);
        movement.right.move(false);
        movement.left.move(false);
        //
        if (!actionUtils.checkStatus()) {
